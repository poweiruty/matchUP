...
public class CorpRequestDto {
	...
	public CorpRequestDto(String cid, String cpassword, String cname, int cnum, String mgr_name, int mgr_tel) {
		this.cid = cid;
	...
	public CorpRequestDto(String cid, String cpassword, String cname, int cnum, String mgr_name, int mgr_tel, String mgr_email,
			String caddress) {
		this.cid = cid;
		this.cpassword = cpassword;
		this.cname = cname;
